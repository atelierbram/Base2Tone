...
overwrite_to_file()
{
  ...
  base16-builder --scheme "../db/schemes/base2tone-porch.yml" --template "../db/templates/svg/interior.svg.ejs" > "../output/svg/interior-base2tone-porch.svg.inc"
  base16-builder --scheme "../db/schemes/base2tone-field.yml" --template "../db/templates/svg/interior.svg.ejs" > "../output/svg/interior-base2tone-field.svg.inc"
  base16-builder --scheme "../db/schemes/base2tone-motel.yml" --template "../db/templates/svg/interior.svg.ejs" > "../output/svg/interior-base2tone-motel.svg.inc"
 }
